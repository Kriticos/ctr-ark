...
<div class="p-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Criar Nova Permissão</h2>
            <p class="text-gray-600 dark:text-gray-400 mt-1">Adicione uma nova permissão de acesso ao sistema</p>
        </div>
