...
<div class="p-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Criar Novo Menu</h2>
            <p class="text-gray-600 dark:text-gray-400 mt-1">Adicione um novo menu ou submenu ao sistema</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="target" id="target"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            <option value="_self" {{ old('target') == '_self' ? 'selected' : '' }}>Mesma aba (_self)</option>
